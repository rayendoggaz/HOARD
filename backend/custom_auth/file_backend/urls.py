...
from .views import FileList, download_file,CustomFileDelete,toggle_pin_file,PinnedFilesAPIView,file_preview,search_files, unpin_file
urlpatterns = [
    ...
    path('files/<str:file_uid>/unpin/', unpin_file, name='unpin-file'),
